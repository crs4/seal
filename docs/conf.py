...
#release = '0.1.0'
release = "devel-TIMESTAMP"
VerPath = os.path.join(os.path.dirname(__file__), '..', 'VERSION')
...
# of the sidebar.
html_logo = "_static/seal_logo_1_small.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "_static/seal_logo_1.ico"
