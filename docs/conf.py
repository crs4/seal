...
project = u'PairReadsQSeq'
copyright = u'2010, CRS4'
...
version = ".".join(full_version.split(".", 2)[:2])
...
htmlhelp_basename = 'PairReadsQSeqdoc'
...
latex_documents = [
  ('index', 'PairReadsQSeq.tex', u'PairReadsQSeq Documentation',
   u'Simone Leo, Luca Pireddu, Gianluigi Zanetti', 'manual'),
]
